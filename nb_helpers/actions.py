...
# %% auto 0
__all__ = ['get_colab_url2md', 'create_comment_body', 'get_api', 'after_pr_colab_link', 'upload_at', 'post_reply',
           'update_comment', 'create_issue_nb_fail']
...
def post_reply(owner="wandb", repo="nb_helpers", token=None):
    api, payload = get_api(owner, repo, token)
    print(api.actions.list_workflow_run_artifacts(github_context.run_id))
