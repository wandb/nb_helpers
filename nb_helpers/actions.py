...
# %% auto 0
__all__ = ['get_colab_url2md', 'create_comment_body', 'get_api', 'after_pr_colab_link', 'upload_at', 'download', 'update_comment',
...
def download(owner="wandb", repo="nb_helpers", token=None):
    ...
    print(payload)
    print("=============\n\n")
    print(api.actions.list_workflow_run_artifacts(payload.workflow_run.id))
