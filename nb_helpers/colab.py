...
# %% auto 0
__all__ = ['get_colab_url', 'has_colab_badge', 'cell_is_empty', 'remove_empty_cells', 'remove_colab_badges',
           'create_colab_badge_cell', 'add_colab_badge', 'add_colab_metadata']
...
def remove_empty_cells(notebook):
    ...
    notebook['cells'] = [cell for cell in notebook['cells'] if not cell_is_empty(cell)]
    return notebook
...
def remove_colab_badges(notebook):
    ...
    for cell in notebook['cells']:
        if cell['cell_type'] == 'markdown' and search_cell(cell, "colab.research.google"):
            ...
            new_lines = []
            for line in lines:
                if "colab.research.google" not in line:
                    break
                elif "@wandbcode" not in line:
                    break
                else:    
